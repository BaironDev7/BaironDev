  ...
  return (
    <section id="Sobremi" className="text-secondary lg:p-8">
      <div className="max-w-lg mx-auto">
        ...
        <p className="mb-4 text-base">
          Me esfuerzo constantemente por mantenerme al tanto de las últimas tendencias y mejores prácticas de la industria, con el fin de ofrecer un valor <span className="text-primary">excepcional</span>, ya sea en una empresa o para clientes que merecen lo mejor de la <span className="text-primary">tecnología</span>.
        </p>
      </div>
    </section>
  );
